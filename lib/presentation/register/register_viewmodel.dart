...
class RegisterViewModel extends BaseViewModel
  ...
  StreamController isUserRegisterInSuccessfullyStreamController = StreamController<bool>();
  ...
  setProfilePicture(File file) {
    ...
    if (file.path.isNotEmpty) {
      // update register view object with profilePic value
      registerViewObject = registerViewObject.copyWith(
          profilePic: file.path); // using data class like kotlin
    } else {
      // reset profilePic value in register view object
      registerViewObject = registerViewObject.copyWith(profilePic: "");
    }
    _validate();
  }
  ...
  bool _validateAllInputs() {
    return registerViewObject.profilePic.isNotEmpty &&
